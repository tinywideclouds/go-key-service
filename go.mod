module github.com/tinywideclouds/go-key-service
...
require (
	...
	github.com/illmade-knight/go-microservice-base v0.0.7
...
require (
	...
	github.com/tinywideclouds/gen-platform v0.0.2 // indirect
